...
This file defines all the I/O functions with clients, primaries and replicas
...
One of the most important functions inside this file is `replicationFeedReplicas()` that writes commands to the clients representing replica instances connected
...
used in order to perform the first synchronization between primaries and
