...
#define CLUSTER_DEFAULT_REPLICA_VALIDITY 10 /* Replica max data age factor. */
#define CLUSTER_DEFAULT_REQUIRE_FULL_COVERAGE 1
#define CLUSTER_DEFAULT_REPLICA_NO_FAILOVER 0 /* Failover by default. */
...
#define CLUSTER_NODE_NOFAILOVER 512 /* Replica will not try to failver. */
...
typedef struct clusterNode {
    ...
    int numreplicas;  /* Number of replica nodes, if this is a primary */
    struct clusterNode **replicas; /* pointers to replica nodes */
    struct clusterNode *replicaof; /* pointer to the primary node. Note that it
